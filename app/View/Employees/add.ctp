    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('Employee',  array('url' => array('controller' => 'employees', 'action' => 'add'),'type'=>'file','inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('role_title', array('div' => false, 'label' => 'Role Title', 'type' => 'text', "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('joining_date', array('div' => false, 'label' => '入社日', 'type' => 'text','readonly'=>'true', "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('lunch_time', array('div' => false, 'label' => 'ランチタイム', 'type' => 'text', "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
...
$('#EmployeeStartLunchTime,#EmployeeEndLunchTime').on('blur',function() 
{
    var start_time = $('#EmployeeStartLunchTime').val();
    var end_time = $('#EmployeeEndLunchTime').val();

    // var diff =  new Date(end_time) - new Date( start_time);  
    var diff = ( new Date("1970-1-1 " + end_time) - new Date("1970-1-1 " + start_time) ) / 1000 / 60 ;  
    $('#EmployeeLunchTime').val(diff);
    if(diff <= 0){
       $('#EmployeeLunchTime').val(0);
       if((start_time != '') && (end_time != '')){
            alert('Please Select Valid Time');
             return false;
       }
        
            // $('#EmployeeLunchTime').append('<div>please slect.</div>');
