    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('Customer',  array('url' => array('controller' => 'customers', 'action' => 'add'),'type'=>'file','inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                ...
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('tel', array('div' => false, 'label' => '電話 No', 'type'=>'text', "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <?php $attributes = array('legend' => '性別');?>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('age', array('div' => false, 'label' => 'Age', 'type' => 'text', "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
