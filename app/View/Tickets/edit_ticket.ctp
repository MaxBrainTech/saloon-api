<?php 
$ticket_price = substr($this->request->data['Ticket']['ticket_price'],0,-3);
$ticket_amount = substr($this->request->data['Ticket']['ticket_amount'],0,-3);
?>
<div class="row">
    <ol class="breadcrumb">
        <li><a href="#">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('Ticket',  array('url' => array('controller' => 'tickets', 'action' => 'edit_ticket'),'type'=>'file','inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                <?php
                ...
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('ticket_price', array('div' => false, 'label' => '在庫数','type'=>'text', 'id'=>'ticket_price', 'value'=>$ticket_price,"class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('ticket_amount', array('div' => false, 'label' => 'チケット金額', 'type'=>'text','id'=>'ticket_amount','value'=>$ticket_amount, "class" => "form-control"))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('ticket_num_time', array('div' => false, 'label' => 'チケット合計','type'=>'text','id'=>'ticket_num_time', "class" => "form-control"))); ?>
                    </div>
                </div>
