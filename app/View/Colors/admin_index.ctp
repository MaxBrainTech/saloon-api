<div class="content-box <?php echo (($search_flag==0)?'closed-box':'');?>"><!-- Start Content Box -->
	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab">
			...
			<?php echo ($this->Form->create('Color', array('id'=>'SearchForm','url'=>array('admin'=>true, 'controller' => 'colors', 'action' => 'index'),'onsubmit'=>'javascript: return true;')));?>
...
<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-header">
		...
		<h3 style="cursor: s-resize;">Manage colors</h3>
		 <div class="total">
            <?php echo $this->element('Admin/admin_total', array("paging_model_name" => "Color", "total_title" => "colors")); ?>
        </div>
	...
	<div class="content-box-content">
		...
		<?php
		echo ($this->Form->create('Color', array('name'=>'Color', 'url' => array('controller' => 'colors', 'action' => 'process'))));
		...
		<div class="tab-content<?php echo ($defaultTab==$tab?' default-tab':'');?>" id="<?php echo ($tab);?>"> <!-- This is the target div. id must match the href of this div's tab -->
			...
			<div id="target<?php echo ($tab);?>"><?php
					echo ($defaultTab==$tab?$this->element('Admin/Color/table'):'');
			?></div>
