        ...
        <?php if($this->request->params['pass'][0] == 1) {?>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php echo $this->Form->create('Reservation',  array('url' => array('controller' => 'calenders', 'action' => 'add_reservation'),'inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                    <?php  echo ($this->Form->input('id'));?>
                    <?php  echo ($this->Form->input('reservation_type',array('type'=>'hidden','value'=>$this->request->params['pass'][0])));?>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <?php echo ($this->Form->input('customer_name', array('div' => false, 'label' => 'Name', 'type'=>'text', 'id'=>'customer_name', "class" => "form-control","maxlength"=>30))); ?>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
