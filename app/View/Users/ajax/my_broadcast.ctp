<section id="collaborative-col">
	  <div class="pad0 gradient-transparent">
		...
		<?php if(!empty($user_feeds)){?>
			...
			<!--  VIDEO POPUP  -->
				<!-- Modal -->
			<div class="modal fade" id="myModal<?php echo $keyFeed;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						...
						<img src="<?php echo $feedVal['Feed']['original_image_url'];?>" class="image-responsive" width="250" height="165" />
							<div class="pic-hover">   
								<div class="one-fourth-icon transition"> 
									<a href="#"><?php echo $this->Html->image('search_icon.png', array( "data-toggle"=>"modal", "data-target"=>"#myModal$keyFeed"));?></a>
