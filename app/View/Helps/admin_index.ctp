<div class="content-box <?php echo (($search_flag == 0) ? 'closed-box' : ''); ?>"><!-- Start Content Box -->
    ...
    <div class="content-box-content">
        <div style="display: block;" class="" id="tab">
            <?php echo ($this->Form->create('HelpQuestion', array('id' => 'SearchForm', 'url' => array('admin' => true, 'controller' => 'helps', 'action' => 'index'), 'onsubmit' => 'javascript: return true;'))); ?>
            <fieldset>
               <p>
                    <label>Email</label>
...
<div class="content-box"><!-- Start Content Box -->
    ...
    <div class="content-box-header">
        ...
        <h3 style="cursor: s-resize;">Manage Customers</h3>
         <div class="total">
            <?php echo $this->element('Admin/admin_total', array("paging_model_name" => "Help", "total_title" => "Helps")); ?>
        </div>
    ...
    <div class="content-box-content">
        ...
        <?php
        echo ($this->Form->create('HelpQuestion', array('name' => 'HelpQuestion', 'url' => array('controller' => 'helps', 'action' => 'process'))));
        ...
        foreach ($tabs as $tab => $count) {
            ...
            <div class="tab-content<?php echo ($defaultTab == $tab ? ' default-tab' : ''); ?>" id="<?php echo ($tab); ?>"> <!-- This is the target div. id must match the href of this div's tab -->
                ...
                <div id="target<?php echo ($tab); ?>"><?php
                    echo ($defaultTab == $tab ? $this->element('Admin/Help/table') : '');
                    ?></div>
...
//var CurrentUrl = SiteUrl+'/admin/helps/index/client';
