      ...
      <div class="payemt_form_inner">
        <form action="/stripe/get_response" method="post" id="payment-form">
          <div class="form-row">
             ...
             ?>
            <h3 style="color: #000; text-align: center; padding:15px 0;"><strong>Pay <?php echo $plan_amount; ?>¥ to JTS Board</strong></h3>
          ...
          <button id="submit_button_load" class="btn btn-primary btn-block mt-4" disabled="disabled" style="display: none;">Please Wait...</button>
