...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">サービス Detail</div>
            <div class="panel-body">
                <?php $this->Layout->sessionFlash(); ?>
                <?php echo $this->Form->create('Service',  array('url' => array('controller' => 'services', 'action' => 'add'),'inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                <?php  echo ($this->Form->input('id'));?>
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('name', array('div' => false, 'label' => 'サービス Name', 'type'=>'text', "class" => "form-control","maxlength"=>30))); ?>
                    </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
