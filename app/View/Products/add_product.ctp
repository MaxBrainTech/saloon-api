    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('Product',  array('url' => array('controller' => 'products', 'action' => 'add_product'),'type'=>'file','inputDefaults' => array(  'error' => array('attributes' => array('wrap' => 'span',    'class' => 'input-notification error png_bg'))) ));?>
                <?php
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('product_purchase_price', array('div' => false, 'label' => '購買価格', 'type'=>'text','id'=>'product_purchase_price', "class" => "form-control"))); ?>
                    </div>
                </div>
                 <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <?php echo ($this->Form->input('product_sale_price', array('div' => false, 'label' => '売価','type'=>'text','id'=>'product_sale_price', "class" => "form-control"))); ?>
                    </div>
                </div>
