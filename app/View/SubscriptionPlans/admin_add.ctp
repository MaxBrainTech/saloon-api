<div class="content-box"><!-- Start Content Box -->
	...
	<div class="content-box-header">
		...
		<h3 style="cursor: s-resize;">Add a new SubscriptionPlan</h3>
	...
	<div class="content-box-content">
		...
		<div style="display: block;" class="" id="tab2">
			...
			echo $this->Form->create('SubscriptionPlan', 
				array('url' => array('controller' => 'subscription_plans', 'action' => 'add'),
			'inputDefaults' => array(
				'error' => array(
					'attributes' => array(
						'wrap' => 'span',
				...
				<?php echo ($this->element('Admin/SubscriptionPlan/form'));?>
