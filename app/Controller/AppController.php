...
class AppController extends Controller {
    ...
    public function beforeFilter() {
        ...
        $salon_name = '';
        if(!empty($this->Auth->user('salon_name'))){
            $salon_name = $this->Auth->user('salon_name');
        }
        $this->set(compact('salon_name'));
	...
	public function sendMailss($to, $subject, $message, $from, $template_id = null ){
        ...
        $message = array();
        $message['from'] = "JTSボード <mailgun@mg.jtsboard.com>";
        $message['to'] = $to;
...
/*	
        ...
        $config['api_url'] = "https://api.mailgun.net/v3/" . $domain . "/messages";
        $message = array();
        $message['from'] = "JTSBoard <mailgun@mg.jtsboard.com>";
        $message['to'] = $to;
        $message['subject'] = $subject;
...
*/
        ...
        $this->Email->to = $to;
        $this->Email->from = 'do-not-reply@jtsboard.com';
