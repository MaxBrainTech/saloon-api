...
*
*****************************************************************************/
class WebServicesv38Controller extends AppController{
     ...
     *********************************************************************/
     ...
     function add_employee($test_data =null){
        ...
        if(isset($employeeEmailExist['Employee']['id']) && !empty($employeeEmailExist['Employee']['id'])){
            $responseArr = array('status' => 'error', 'msg' => 'このメールが他の従業員を登録してした'  );
            $jsonEncode = json_encode($responseArr);
        }else{
 ...
 /**************************************************************************
    ...
    function add_reservation(){
       ...
       // print_r($decoded);die;
        ...
        $reservation['Reservation']['employee_ids'] = isset($decoded['employee_ids']) ? $decoded['employee_ids'] : '0';
