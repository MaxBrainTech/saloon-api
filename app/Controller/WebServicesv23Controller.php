...
*
*****************************************************************************/
class WebServicesv23Controller extends AppController{
    ...
    function add_reservation(){
       ...
       // print_r($decoded);die;
        ...
        if($this->Reservation->saveAll($reservation)){
            ...
            $reservationNotificationMessage =  'Reservation added successfully.';
...
/****************************************************************************************************************************************
    ...
    function add_employee_chat($test_data = null){
        ...
        if($this->EmployeeChat->saveAll($employeeChat)){
            ...
            $chatNotificationMessage = $emp_name.' send chat successfully.';
...
function upload_gallery_image(){
    ...
    function add_gallery_image($test_data = null){
        ...
        if($this->Gallery->saveAll($gallery)){
            ...
            $galleryImageNotificationMessage =  'Gallery image added successfully.';
