...
*
*****************************************************************************/
class WebServicesv30Controller extends AppController{
...
/*
 ...
 /**************************************************************************
    ...
    function attendance_info180119($testData = null){
                ...
                if(!empty($data)){
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        if(!empty($customerData['Attendance'][$i]['checkin_time']) && !empty($customerData['Attendance'][$i]['checkout_time'])){
                            ...
                            $first_over_time = ($starting_total_time - $salonWorkingTime);
                            $extra_time =  0;
                            
                            if($first_over_time > 0){
                                $start_let_time = 0;
                                if($startTime > $to_time){
                                    $to_time =  $startTime;
                                }else{
                                    $start_let_time = ($to_time - $startTime);
                                }

                                if($endTime < $from_time){
                                    $after_form_time =  (($from_time - $endTime)/60);
                                    if($start_let_time > 0){
                                        $after_form_time = $after_form_time - $start_let_time;
                                    }
                                    
                                    $from_time = ($endTime + floor($after_form_time/$over_time));
                                    $overTime = ($total_time - $salonWorkingTime);
                                    if($after_form_time > $over_time){
                                      $extra_time =  ((floor($after_form_time/$over_time)*$over_time));
                                    }
                                }
                            ...
                            $endOverCheckOutTime = strtotime($endCheckOutTime);
                            if($endOverCheckOutTime > $endTime){
                                $overTime = ($endOverCheckOutTime - $endTime);
                                $overTimeMinutes = ($overTime/60);
                                if($over_time <= $overTimeMinutes){
                                    $countOverTimeInt = floor($overTimeMinutes/$over_time);
                                    $overTime = $countOverTimeInt*$over_time;

                                    
                                    $over_time_hours   = floor(($overTime) / 60);
                                    if($over_time_hours > 0){
                                        $over_time_minutes =  floor(($overTime - ($over_time_hours * 60)));
                                    }else{
                            ...
                            $total_time = round(abs($to_time  - $from_time) / 60,2);
                            $total_working_time = ($starting_total_time - $salonWorkingTime);
                            if(($extra_time > 0) && ($total_working_time > 0)){
...
/****************************************************************************************************************************************
    ...
    function monthly_attendance1801209($test_data = null){
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        if($interval_lunch_time == 0){
                         ...
                         if(!empty($customerData['Attendance']['checkin_time']) && !empty($customerData['Attendance']['checkout_time'])){
                                ...
                                if($endCheckOutTimes >  $office_end_time){
                                    $overTime = ($endCheckOutTimes - $office_end_time);
                                    $total_time = ($total_time - $overTime);
                                    $overTimeMinutes = ($overTime/60);
                                    ...
                                    // echo 'totalOverTime : '.$totalOverTime.'<br />';
...
/**************************************************************************
    ...
    function get_reservation_ipad_oldss($testData = null){
                        ...
                        $start_time = strtotime($value['Reservation']['start_time']);
                            ...
                            if($value['Reservation']['reservation_type']== '3'){
                                ...
                                if($value['Reservation']['all_day']== '1'){
                                   ...
                                   /* if($value['Reservation']['note']!='null')
                                        
                                    else
                                        $reservationData[$sectionType][$morning]['note']= '';
                                    *///$reservationData[$sectionType][$morning]['note']= $value['Reservation']['note'];
    ...
    function get_reservation_ipad($testData = null){
        ...
        if(!empty($user_id)){
            ...
            if(!$userData){
                ...
                $this->Reservation->bindModel(array('belongsTo' => array('Customer', 'Service')));
                /*$reservationDataFind = $this->Reservation->find('all',array('conditions'=>array( 'Reservation.user_id'=>$user_id, 'Reservation.start_date >=' => $sdate, 'Reservation.start_date <=' => $edate),  'order' => array('Reservation.start_date' => 'DESC', 'Reservation.start_time' => 'ASC')));*/
                $reservationDataFind = $this->Reservation->find('all',array('conditions'=>array( 'Reservation.user_id'=>$user_id, 'Reservation.start_date <=' => $date, 'Reservation.end_date >=' => $date),  'order' => array('Reservation.start_date' => 'DESC', 'Reservation.start_time' => 'ASC')));
                    ...
                    foreach ($reservationDataFind as $key => $value) {
                        ...
                        $start_time = strtotime($value['Reservation']['start_time']);
                            ...
                            if($value['Reservation']['reservation_type']== '3'){
                                ...
                                if($value['Reservation']['all_day'] =='1'){
                                     $reservationData[$sectionType][$staff]['start_date']= $value['Reservation']['start_date'];
                                     $reservationData[$sectionType][$staff]['start_time']= '00:00:00';
                                     $reservationData[$sectionType][$staff]['end_time']= '00:00:00';
                                }else{
                                    $reservationData[$sectionType][$staff]['start_date']= $value['Reservation']['start_date'];
                                    $reservationData[$sectionType][$staff]['start_time']= $value['Reservation']['start_time'];
                                    $reservationData[$sectionType][$staff]['end_time']= $value['Reservation']['end_time'];
                            ...
                            if($value['Reservation']['reservation_type']== '3'){
                                ...
                                if($value['Reservation']['all_day']== '1'){
                                    ...
                                    if(!empty($serviceColor['ServiceColor']['color_code'])){
                                        ...
                                        $reservationData[$sectionType][$all_day]['service_color']= '';
                                    }
                                    $reservationData[$sectionType][$all_day]['customer_name']= $value['Customer']['last_name'].' '.$value['Customer']['first_name'];
                                    $last_visit =  isset($value['Customer']['last_visit']) ? $value['Customer']['last_visit'] : $value['Customer']['modified'];
                                    if(empty($last_visit))
                                    ...
                                    $reservationData[$sectionType][$morning]['extra_end_date']= $value['Reservation']['extra_end_date'];
                                     ...
                                     if(!empty($serviceColor['ServiceColor']['color_code'])){
                                        ...
                                        $reservationData[$sectionType][$morning]['service_color']= '';
                                     }
                                     $reservationData[$sectionType][$morning]['customer_name']= $value['Customer']['last_name'].' '.$value['Customer']['first_name'];
                                     $last_visit =  isset($value['Customer']['last_visit']) ? $value['Customer']['last_visit'] : $value['Customer']['modified'];
                                     if(empty($last_visit))
                                    ...
                                    $reservationData[$sectionType][$afternoon]['extra_end_date']= $value['Reservation']['extra_end_date'];
                                     ...
                                     if(!empty($serviceColor['ServiceColor']['color_code'])){
                                        ...
                                        $reservationData[$sectionType][$afternoon]['service_color']= '';
                                     }
                                     $reservationData[$sectionType][$afternoon]['customer_name']= $value['Customer']['last_name'].' '.$value['Customer']['first_name'];
                                     $last_visit =  isset($value['Customer']['last_visit']) ? $value['Customer']['last_visit'] : $value['Customer']['modified'];
                                     if(empty($last_visit))
