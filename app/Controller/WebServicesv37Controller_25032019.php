...
class WebServicesv37Controller extends AppController{
   ...
   /************************************************************************************************************************************
    ...
    function signup($test_data = null){
        ...
        {
             $responseArr = array('msg' => "This email on hotmail.com.please use 'gmail.com' email for account scurity prepose.", 'msg1' => "This email on hotmail.com.please use 'gmail.com' email for account scurity prepose.",  'status' => 'error' );
            $jsonEncode = json_encode($responseArr);
            return $jsonEncode;
        }
        ...
        if($this->User->saveAll($user)){
            ...
            $activation_url = 'http://api.jtsboard.com/users/email_confirm/'.$user_id;
