...
App::import('Vendor', 'aws-sdk', array('file' => 'aws_sdk'.DS.'sdk.class.php')); 
...
class EmailServiceComponent extends EmailComponent { 
	...
	{
		$ses = new AmazonSES(array('certificate_authority' => false,	
       'key' => 'ses-smtp-user.20140223-222012',
       'secret' => 'AKIAIG7QOHIF2AA2PHJQ'));
		return $ses;
	}
