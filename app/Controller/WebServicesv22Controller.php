        ...
        if(!empty($emp_code)){
           ...
           // print_r($employeeCode );die;
            if(isset($employeeCode['Employee']['user_id']) && !empty($employeeCode['Employee']['user_id']) ){
                $this->User->id = $employeeCode['Employee']['user_id'];
...
function upload_gallery_image(){
    ...
    function add_gallery_image($test_data = null){
        ...
        $gallery['Gallery']['album_id'] = isset($decoded['album_id']) ? $decoded['album_id'] : '';
...
/*
    ...
    function sendAPNSmessage($devicetokens=null, $type=null, $body=null) {
        ...
        $base_path = ROOT.DS.APP_DIR.DS.WEBROOT_DIR;
        $tCert =  $base_path.'/pushpem/PushChatCert.pem';
        ...
        $tToken = '6546607f4d849650bc19e835b1d567a6ed47cb592fc2d86daa3e0349bf9244b6';
    ...
    // pr($tSocket);die;
     ...
     $deviceToken = '6546607f4d849650bc19e835b1d567a6ed47cb592fc2d86daa3e0349bf9244b6';
     $passphrase = '123456';
     $message = 'My ';
     $base_path = ROOT.DS.APP_DIR.DS.WEBROOT_DIR;

    $path_to_cert = $base_path.'/pushpem/PushChatCert.pem';
    // echo $path_to_cert;die;
    $ctx = stream_context_create();
    ...
    // xdebug_break();
     // Open a connection to the APNS server
     $fp = stream_socket_client(
          'ssl://gateway.push.apple.com:2196', $err,
          $errstr, 60, STREAM_CLIENT_CONNECT|STREAM_CLIENT_PERSISTENT, $ctx);
     // pr($err);
     // pr($errstr);die;
     if (!$fp)
  ...
  public function iphonePushNotification($dtoken, $notification) {
                 //here you can define  developer account and distribution accout      
                // $apnsHost = 'gateway.sandbox.push.apple.com';
                $apnsHost ='gateway.push.apple.com';
               
                $data["msg"] = 'test push notification.';
