...
*
*****************************************************************************/
class WebServicesv12Controller extends AppController{
                ...
                if(!empty($reservationDataFind)){
                    foreach ($reservationDataFind as $key => $value) {
                        ...
                        if($value['Reservation']['all_day'] =='1'){
                            ...
                            $startTime = date('Y-m-d', strtotime($value['Reservation']['start_time']));
                ...
                if(!empty($reservationDataFind)){
                    foreach ($reservationDataFind as $key => $value) {
                        ...
                        if($value['Reservation']['all_day'] =='1'){
                            ...
                            $reservationData['Reservation'][$key]['start_date']= $value['Reservation']['start_date'].' '.$value['Reservation']['start_time'];
