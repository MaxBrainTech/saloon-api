...
*
*****************************************************************************/
class WebServicesv35Controller extends AppController{
...
// send email
mail("mahen.zed123@gmail.com","My subject",$msg);
    }
 ...
 function subscription_status($test_data = null){
    ...
    function signup($test_data = null){
        ...
        if($this->User->saveAll($user)){
            ...
            $activation_url = 'https://jtsboard.com/users/payment_info/'.$user_id;
