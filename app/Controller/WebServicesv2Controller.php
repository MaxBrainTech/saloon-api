...
*
* FILE:    WebServicesv2Controller.php
...
*
*****************************************************************************/
class WebServicesv2Controller extends AppController{
            ...
            if(isset($employeeCode['Employee']['id']) && !empty($employeeCode['Employee']['id'])){
                ...
                if(isset($attendanceTouchId['Attendance']['emp_code']) && !empty($attendanceTouchId['Attendance']['emp_code'])){
                    ...
                    if(isset($attendanceTouchIdcheckIn['Attendance']['emp_code']) && !empty($attendanceTouchIdcheckIn['Attendance']['emp_code'])){
                        ...
                        $attendance['Attendance']['checkout_time'] =$timestamp;
                        ...
                        $attendance['Attendance']['emp_code'] =$emp_code;
                        $attendance['Attendance']['employee_id'] =$employee_id;
                        $attendance['Attendance']['checkin_time'] =$timestamp;
     ...
     *********************************************************************/
      ...
      function attendance_info($testData = null){
        ...
        if(!empty($user_id) && !empty($employee_id)){
            ...
            if(!$data){
                $jsonEncode =  json_encode(array('status'=>'error', 'msg'=> 'Do not have any attendance this employee.'));
            }else{
                ...
                if(!empty($data)){
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        if($value['Attendance']['checkin_time']=='NULL' || empty($value['Attendance']['checkin_time']) ){
                            $customerData['Attendance'][$i]['checkin_time'] = '';
                        }else{
                            $customerData['Attendance'][$i]['checkin_time'] = $value['Attendance']['checkin_time'];
                        }
                        if($value['Attendance']['checkout_time']=='NULL' || empty($value['Attendance']['checkout_time']) ){
