 ...
 *
 */
class HairRemoval extends AppModel {
    ...
    function get_service_list() {
        $charities = $this->find('list', array('conditions' => array('HairRemoval.status' => Configure::read('App.Status.active'))));
        return $charities;
    }
